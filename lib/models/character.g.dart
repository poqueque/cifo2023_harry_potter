...
void _characterSerialize(
  ...
  writer.writeLong(offsets[7], object.totalStars);
...
Character _characterDeserialize(
  ...
  final object = Character(
    id: id,
    magic: reader.readLongOrNull(offsets[1]) ?? 0,
    name: reader.readString(offsets[2]),
    reviews: reader.readLongOrNull(offsets[3]) ?? 0,
    speed: reader.readLongOrNull(offsets[4]) ?? 0,
    strength: reader.readLongOrNull(offsets[6]) ?? 0,
    totalStars: reader.readLongOrNull(offsets[7]) ?? 0,
